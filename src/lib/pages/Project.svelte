                ...
                <div class="col-md-4 col-sm-6">
                    <div class="item">
                        <div class="thumb">
                            ...
                            <div class="image">
                                <img alt="" src="/img/first_item.jpg">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6">
                    <div class="item">
                        <div class="thumb">
                            ...
                            <div class="image">
                                <img alt="" src="/img/second_item.jpg">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6">
                    <div class="item">
                        <div class="thumb">
                            ...
                            <div class="image">
                                <img alt="" src="/img/third_item.jpg">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6">
                    <div class="item">
                        <div class="thumb">
                            ...
                            <div class="image">
                                <img alt="" src="/img/fourth_item.jpg">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6">
                    <div class="item">
                        <div class="thumb">
                            ...
                            <div class="image">
                                <img alt="" src="/img/fifth_item.jpg">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6">
                    <div class="item">
                        <div class="thumb">
                            ...
                            <div class="image">
                                <img alt="" src="/img/sixth_item.jpg">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6">
                    <div class="item">
                        <div class="thumb">
                            ...
                            <div class="image">
                                <img alt="" src="/img/seventh_item.jpg">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6">
                    <div class="item">
                        <div class="thumb">
                            ...
                            <div class="image">
                                <img alt="" src="/img/eight_item.jpg">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6">
                    <div class="item">
                        <div class="thumb">
                            ...
                            <div class="image">
                                <img alt="" src="/img/ninth_item.jpg">
                            </div>
                        </div>
                    </div>
                </div>
